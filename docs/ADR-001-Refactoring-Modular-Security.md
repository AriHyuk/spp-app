...
**Keputusan:**
Saya mengimplementasikan tiga pendekatan arsitektural utama:
...
- _Opsi A: Menggunakan ORM Pihak Ketiga (seperti Eloquent) atau Framework (seperti Laravel)._
  - Alasan Penolakan: Mengubah base teknologi dari prosedural murni menjadi Framework modern merupakan perubahan terlalu invasif (rewrite total). Objektif utama saya adalah meningkatkan standar kode secara gradual dengan _cost of refactor_ yang minim pada stack yang _existing_.
